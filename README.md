...
- a clearly labeled QA menu for forcing 3, 4, or 5 CORE bonus offers, available in every build; and
...
Every build, including the published one, exposes a clearly labeled QA cheat menu. It fabricates a marked pending bonus choice without consuming the random stream. Cheat-generated feature results remain marked as developer-generated and are structurally separate from ordinary spins and simulation, so a forced feature cannot misrepresent the declared mathematics. This is a deliberate choice for a virtual-credit teaching simulator: being able to reach the feature on demand is worth more here than hiding the control.
